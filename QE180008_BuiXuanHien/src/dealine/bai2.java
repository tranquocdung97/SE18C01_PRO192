    ...
    public static String time1(String time) {
        ...
        if (denominator == 1) {
            if (numerator < 2) {
                ...
                result = Integer.toString((int) numerator) + "pi";   //kết quả nếu mẫu số bằng 1
            }
        } else {
            if (numerator < 2) {
                result = "pi/" + denominator;
            } else {
                result = (int)numerator + "pi/" + denominator;   //kết quả nếu mẫu số khác 1
            }
        }
